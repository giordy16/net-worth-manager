                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Checkbox(
                                    value: controller.sameValueCheckBox.value,
                                    onChanged: (value) {
                                      controller.sameValueCheckBox.value = value!;
                                    })
                              ],
                            ),
                          ),
                          ...
                          Visibility(
                              visible: !controller.sameValueCheckBox.value,
                              child: Column(
                                children: [
                                  TextFormField(
                                      decoration: InputDecoration(
  ...
  Future<void> addTransaction() async {
    await controller.addTransaction(
        TransactionEntity(
            ...
            controller.sameValueCheckBox.value ? 1 : double.parse(changeCurrencyController.text),
            product.ticker),
        product);
